...
actor = Sequential([Dense(8, activation="relu", input_shape=input_shape),
...
visual.plot_vectors([rewards, actor_loss, actor_utility, actor_std, actor_kld, actor_entropy, critic_loss],
                    ["Reward", "Actor Loss", "Actor Utility", "Actor STD", "Actor KLD", "Actor Entropy", "Critic Loss"],
